...
"use strict";
var broadcastInfo, clients, createRoom, doUserName, htmlEntities, http, joinRoom, listRooms, rooms, server, userNames, webSocketServer, webSocketsServerPort, wsServer;
...
joinRoom = function(userName, room, index) {
  var client, clientell, clnt, json, _i, _len;
